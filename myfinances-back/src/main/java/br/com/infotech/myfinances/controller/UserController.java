...
public class UserController implements IUserController {
  ...
  public ResponseEntity<Void> changePassword(@RequestParam("userId") Long userId, @RequestParam("oldPassword") String oldPassword,
  ...
  @Override
  @GetMapping
  public ResponseEntity<Page<UserDto>> findAll(@RequestParam(value = "statuses", required = false) List<UserStatus> statuses, Pageable pageable) {
  ...
  public ResponseEntity<Void> changeStatus(@PathVariable("id") Long id, @RequestParam("status") UserStatus status) {
